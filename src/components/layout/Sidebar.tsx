        ...
        <div className="p-4 border-t border-gray-200 flex flex-col gap-2">
          <div className={cn("flex items-center gap-3", !isSidebarOpen && "md:justify-center")}>
            ...
            <div className={cn("flex flex-col overflow-hidden", !isSidebarOpen && "md:hidden")}>
              <span className="text-sm font-medium text-gray-900 truncate">{user?.displayName || 'Docente'}</span>
          ...
          <button
            ...
            className={cn(
              "flex items-center gap-3 px-3 py-2 rounded-lg text-red-600 hover:bg-red-50 transition-colors mt-2",
